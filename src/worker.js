...
// Send heartbeat to MongoDB every 10 seconds
async function sendHeartbeat() {
  try {
    ...
    console.error(`${WORKER_ID}: Error sending heartbeat:`, error);
  }
}
...
setInterval(sendHeartbeat, 10 * 1000); // Send heartbeat every 10 seconds
